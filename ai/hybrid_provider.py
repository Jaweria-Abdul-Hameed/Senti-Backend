...
# {emotion_context}
#
# Write a supportive, stigma-free, compassionate reply that responds to what was actually detected — for example, if Fear is high, acknowledge the anxiety directly rather than guessing at a different emotion.
#
